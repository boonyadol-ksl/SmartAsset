...
<div class="min-h-screen" x-data="userManagement()" x-init="fetchUsers()">
    ...
    <main class="main-content flex-1 p-4 sm:p-6">
        <div class="flex items-center justify-between mb-5">
            <div>
                ...
                <p class="text-sm text-gray-500">สิทธิ์: <span class="font-bold text-blue-600"><?= $me['role'] ?></span></p>
            </div>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <template x-for="user in filteredUsers" :key="user.id">
                            <tr :class="user.id == <?= $me['id'] ?> ? 'bg-blue-50/50' : ''">
                ...
                <div class="space-y-3">
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            <select x-model="formData.role" class="form-input text-sm" :disabled="formData.id == <?= $me['id'] ?>">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            <label class="form-label text-xs">แผนก (Plant Code)</label>
                        ...
                        <div>
                            ...
                            <select x-model="formData.is_active" class="form-input text-sm" :disabled="formData.id == <?= $me['id'] ?>">
...
function userManagement() {
    return {
        ...
        isEdit: false,
        submitting: false,
        formData: { id: '', username: '', full_name: '', plant_code: '', email: '', password: '', role: 'inventory', is_active: 1 },
        ...
        openAddModal() {
            this.isEdit = false;
            this.formData = { id: '', username: '', full_name: '', plant_code: '', email: '', password: '', role: 'inventory', is_active: 1 };
            this.showModal = true;
        },
